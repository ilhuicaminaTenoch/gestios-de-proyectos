                    ...
                    <div class="modal-body">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <button type="button" class="btn btn-block btn-success"
                                                @click="register(id, 1)">Entrada
                                        </button>
                                        <button type="button" class="btn btn-block btn-danger" @click="register(id, 2)">
                                            Salida
                                        </button>
                                    </div>
                                </div>
                        ...
                        <div class="card" v-if="entradaSalida !== 0">
                            <div class="callout callout-success">
                                <h4>{{ messageEntrada }}</h4>
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer justify-content-between">
                        <button type="button" class="btn btn-default" data-dismiss="modal" @click="cleanAll()">Cerrar
                        </button>
                    </div>
                </div>
            </div>
    ...
    methods: {
        ...
        register(id_contratista, bandera) {
            ...
            axios.get(url).then(response => {
                ...
                if (resultado == 0) {
                    this.messageEntrada = 'Debes registrar antes la salida';
                } else if (resultado == 1) {
                    this.messageEntrada = 'Se registro la entrada correctamente';
                } else if (resultado == 2) {
                    this.messageEntrada = 'Se registro la salida correctamente';
                }
