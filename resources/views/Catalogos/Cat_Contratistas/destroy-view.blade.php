                ...
                <form method="post" action="{{ action('ContratistaController@activo') }}" accept-charset="UTF-8">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <input type="hidden" name="idContratista"
                                   value="{{ $contratistas->id_contratista }}"></input>
                        </div>
                        <div class="form-group">
                            <label>Tipo de Baja</label>
                            <select class="form-control" name="tipoBaja">
                                <option value="1">Baja por No conformidad</option>
                                <option value="0">Baja por Termino de Contrato </option>
                            </select>
                        </div>
                    </div>
                    <!-- /.box-body -->
