...
role="dialog" tabindex="-1" id="modal-delete-{{$contra->id_contratista}}">
	{{Form::Open(array('action'=>array('ContratistaController@destroy',$contra->id_contratista),'method'=>'delete'))}}
